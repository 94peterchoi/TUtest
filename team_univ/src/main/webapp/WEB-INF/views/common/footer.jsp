...
<!-- Required Jquery -->
    ...
    <!-- slimscroll js -->
    <script src="${r_path }assets/js/jquery.mCustomScrollbar.concat.min.js "></script>

    <!-- menu js -->
    <script src="${r_path }assets/js/pcoded.min.js"></script>
    <script src="${r_path }assets/js/vertical/vertical-layout.min.js "></script>

    <script type="text/javascript" src="${r_path }assets/js/script.js "></script>
</body>
