            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
						...
						<form action="${gPath }login_check" method="post" name="loginForm" class="md-float-material form-material" ><!-- onsubmit="return loginCheck();" -->
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            <div class="forgot-phone text-right f-right">
                                                ...
                                                <a href="${gPath }searchPwdPage" class="text-right f-w-600">비밀번호 찾기</a>
                                            </div>
                                        </div>
                                    </div>
